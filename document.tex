...
\def \srsTitle{WorkQuest \\ (Project Proposal)}
\def \srsAuthorOne{Atikarn Kruaykriangkrai}
\def \srsAuthorTwo{Napasorn Tevarut}
% \def \srsAuthorThree{Java almond}
\def \srsAcademicYear{2025}

\def \srsAdvisorName{Dr. Tana Wattanawaroon}
